...
<div
  class=" min-h-full transition-transform hover:scale-105 justify-around border border-teal-500/50 bg-teal-100/25 p-4 hover:border-teal-500 hover:bg-teal-100/50 flex-grow bg-teal-100 rounded-lg w-96"
>
